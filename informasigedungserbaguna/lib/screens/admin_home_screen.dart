...
import 'package:informasigedungserbaguna/models/post.dart'; // Sesuaikan jika nama modelnya post.dart
import 'package:informasigedungserbaguna/services/post_services.dart'; // Sesuaikan dengan service Anda
import 'package:informasigedungserbaguna/screens/add_post_screen.dart';
import 'package:informasigedungserbaguna/screens/sign_in_screen.dart'; // Sesuaikan dengan halaman login Anda
import 'package:informasigedungserbaguna/widgets/post_list_item.dart'; // Sesuaikan dengan widget list item Anda
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              "Kelola daftar gedung serbaguna Anda yang terdaftar di Palembang melalui halaman ini.",
          ...
          Expanded(
            child: StreamBuilder<List<Post>>(
              ...
              builder: (context, snapshot) {
                ...
                // Memfilter agar yang muncul HANYA gedung serbaguna yang dibuat oleh admin ini saja
                ...
                if (adminPosts.isEmpty) {
                  return const Center(
                    child: Padding(
                      ...
                      child: Text(
                        "Anda belum mendaftarkan Gedung Serbaguna apapun.\nKetuk tombol (+) di bawah untuk menambahkan.",
